...
| `dr:<dominio>-<n>` | **Sala E · Gremio** 🔒 *(local del proyecto)* | Un **Decision Record** de GREMIO (una decisión de construcción, propiedad de un **Líder**) | `05-Decisiones/` *(la crea GREMIO al operar; hasta entonces el prefijo queda reservado)* | el **Plan** (`plan:<proyecto>`, archivo `plan.md`) enlaza la familia de DRs |
