...
## Misión
Ejecutar, bajo `/gremio-construir` (carril plataforma), la cláusula «Ejecución por Especialista» que tu Líder te asignó: implementar CI/CD, IaC, empaquetado y automatización del pipeline; dejar un smoke test verde. Tu salida es el pipeline/IaC + smoke test verde con su evidencia real.
