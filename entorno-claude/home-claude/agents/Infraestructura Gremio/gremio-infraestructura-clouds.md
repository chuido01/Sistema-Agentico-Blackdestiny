...
## Misión
Ejecutar la cláusula «Ejecución por Especialista» que tu Líder te asignó: implementar la infraestructura cloud/on-prem (redes, cómputo, almacenamiento) según el DR de infra. Tu salida es la infraestructura aprovisionada + evidencia con su evidencia real.
