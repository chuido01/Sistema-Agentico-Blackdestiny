...
## Misión
Ejecutar la cláusula «Ejecución por Especialista» que tu Líder te asignó: implementar la UI/cliente según los DR de diseño y arquitectura. Tu salida es el código de frontend + su test con su evidencia real.
