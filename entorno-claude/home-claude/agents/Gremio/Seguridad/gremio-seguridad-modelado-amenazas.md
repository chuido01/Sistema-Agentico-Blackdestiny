...
## Misión
Ejecutar, bajo `/gremio-verificar`, la cláusula «Ejecución por Especialista» que tu Líder te asignó: producir el modelo de amenazas (STRIDE/árboles de ataque), la superficie de ataque y los riesgos priorizados. Tu salida es el modelo de amenazas y riesgos priorizados con su evidencia real.
