...
## Misión
Ejecutar, bajo `/gremio-verificar`, la cláusula «Ejecución por Especialista» que tu Líder te asignó: diseñar la protección de datos (cifrado at-rest/in-transit, minimización, retención, cumplimiento de protección de datos). Tu salida es el diseño de protección de datos con su evidencia real.
