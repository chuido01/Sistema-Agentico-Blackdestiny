...
## Misión
Ejecutar la cláusula «Ejecución por Especialista» que tu Líder te asignó: diseñar/implementar el esquema relacional (normalización, índices, integridad referencial, migraciones). Tu salida es el esquema relacional + migraciones con su evidencia real.
